...
Samsung<- read.csv("C:/Users/yashs/OneDrive/Documents/archive (6)/SamsungGalaxyS21Ultra_reviews.csv") 

#Check dimension of data
dim(Samsung)#Shows number of rows and columns
class(Samsung)
#Convert data into a corpus
mycorpus<- VCorpus(VectorSource(Samsung$userComments)) #Create a volatile corpus
...
Samsung<- read.csv("C:/Users/13345/Dropbox/My PC (DESKTOP-B1D9GNS)/Downloads/archive (6)/SamsungGalaxyS21Ultra_reviews.csv")
sentiment<- iconv(Samsung$userComments)
